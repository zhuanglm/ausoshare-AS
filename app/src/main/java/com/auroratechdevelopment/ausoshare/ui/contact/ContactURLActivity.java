 ...
 */
public class ContactURLActivity extends ActivityBase implements View.OnClickListener{
...
//        wv = (WebView)findViewById(R.id.contact_url_webview);
    ...
    private void setHeaderTitle(String header_title){
    	...
    	if (header_title.equals(WebServiceConstants.companyTermsConditions)){
    		textTitle.setText(getResources().getString(R.string.contact_t_c_text));
    	}else if (header_title.equals(WebServiceConstants.companyIncomeRule)){
    		textTitle.setText(getResources().getString(R.string.contact_incoming_rule_text));
    	}else if (header_title.equals(WebServiceConstants.companyWithdrawRule)){
    		textTitle.setText(getResources().getString(R.string.contact_withdraw_rule_text));
    	}else if (header_title.equals(WebServiceConstants.companyIntroduction)){
    		textTitle.setText(getResources().getString(R.string.contact_company_introduction_text));
    	}else if(header_title.equalsIgnoreCase(WebServiceConstants.statsWithdrawHistory)){
    ...
    public void onBackPressed() {
		...
		ViewUtils.startPageWithClearStack(bundle, ContactURLActivity.this, HomeActivity.class);
        super.onBackPressed();
    }
